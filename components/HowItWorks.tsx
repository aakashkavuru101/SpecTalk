  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden">
      ...
      <div className="px-4 py-4">
        ...
        <p className="font-[family-name:var(--font-dm-sans)] text-sm text-white min-h-[1.5rem]">
          {inView && (
            <>
...
function OutputCard({ inView }: { inView: boolean }) {
  return (
    <div className="rounded-xl border border-indigo-500/30 bg-indigo-500/5 backdrop-blur-sm overflow-hidden">
      ...
      <div className="px-4 py-4 font-mono text-xs leading-relaxed text-white/80 min-h-[100px]">
        {inView &&
    ...
    <section className="relative w-full overflow-hidden bg-black py-16 md:py-24">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-sora)] text-2xl md:text-3xl font-bold text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8">
          {STEPS.map((step, i) => (
            ...
            >
              ...
              <h3 className="text-sm font-semibold text-white font-[family-name:var(--font-sora)]">
                {step.title}
              </h3>
